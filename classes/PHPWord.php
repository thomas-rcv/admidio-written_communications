...
class PHPWord {
    ...
    /**
     * Load a Description File used as temporary template for Admidio Plugin
     *
     * @param string $strFilename
     * @return PHPWord_Description
     */
     
    public function loadDescription($strFilename) {
        if(file_exists($strFilename)) {
            $description = new PHPWord_Description($strFilename);
            return $description;
        } else {
